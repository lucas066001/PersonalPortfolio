...
export class ChatComponent {
  ...
  private hiddenMessageList: Message[] = [
    new Message($localize`Bonjour, moi c'est Lucas ! (enfin juste son site web pour le moment)`, false, false),
    new Message($localize`Vous pouvez quand même me poser quelques questions, essayez avec : `, false, false),
    new Message($localize`Es-tu disponible ?`, false, true),
    new Message($localize`Quels sont tes projets ?`, false, true),
    new Message($localize`Que fais-tu actuellement ?`, false, true),
    new Message($localize`Comment te contacter ?`, false, true),
  ];
